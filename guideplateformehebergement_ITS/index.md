...
L'objectif est d'anticiper certaines interrogations
...
leur utilité et la page d'accueil. 

Nous passerons ensuite en revue les
différentes typologies de question existantes puis le process de
création de questions. 

Ceci devrait permettre au moment de la création
...
### Alerte crédit {#alerte-crédit .ListParagraph}
 
### Consommation de crédits {#consommation-de-crédits .ListParagraph}
 
### Factures {#factures .ListParagraph}
...
-   Une fois que vous avez choisi le groupe, cliquez sur la flèche bleue
    pointant vers la droite. Cela déplacera le groupe sélectionné
    dans le(s) **Groupe(s) du candidat.**
...
Cliquez sur <span id="_Hlk78285183" class="anchor"></span>**Inscrire**
ou **Inscrire et fermer** si vous souhaitez attribuer un seul test à un
candidat.
...
<span id="_Hlk130568998" class="anchor"></span>Une fois que vous avez
inscrit le groupe à un test, il est temps d’envoyer l’e-mail
d’invitation. Pour cela, vous pouvez utiliser l’option **Envoyer les
e-mails d’inscription à tous les candidats du groupe.**
 
<span id="_Hlk130569609" class="anchor"></span>Sélectionnez **Envoyer
des** **e-mails** **d’inscription à tous les candidats du groupe** et la
fenêtre **Détails du message** s’ouvre. Renseignez les informations
demandées (adresse e-mail de l’expéditeur, titre du message et modèle
d’e-mail), puis cliquez sur **Envoyer**.
...
<span id="_Hlk130569776" class="anchor"></span>Les actions de groupe
vous permettent de :
...
-   <span id="_Hlk130569853" class="anchor"></span>**Supprimer les tests
    non passés.** Si vous supprimez les tests à passer, vous serez alors
    recrédités automatiquement
 
![](media2/23.png)
 
-   <span id="_Hlk130569940" class="anchor"></span>**Définir des options
    d’évaluation pour l’ensemble des candidats du groupe.** Cela vous
    permet de personnaliser les options d’évaluation pour un groupe
    défini
...
<span id="_Hlk130570234" class="anchor"></span>La plateforme vous
fournit un aperçu complet des résultats aux tests.
...
<span id="_Hlk130570366" class="anchor"></span>Vous pouvez effectuer des
recherches dans les données et filtrer par :
...
### Resultats individuel {#resultats-individuel .ListParagraph}
...
<span id="_Hlk130570752" class="anchor"></span>En cliquant sur l’icône
**Affichage**, vous pourrez voir la question, la réponse du candidat, et
la bonne réponse attendue.
 
![](media2/29.png)![](media/30.png)
...
![](media2/35.jpg)![](media2/36.jpg)
 
\*\*\*
 
### <span id="_Toc128038133" class="anchor"><span id="_Toc200989469" class="anchor"></span></span>Émetteurs d’e-mails {#émetteurs-de-mails .ListParagraph}
...
### Sessions de passage  {#sessions-de-passage .ListParagraph}
...
la famille de sujets, puis ciquez sur **Enregistrer**.
...
<span id="_Hlk130573747" class="anchor"></span>Il est conseillé de
vérifier le navigateur de l’ordinateur (s) avant d’exécuter des tests.
Pour trouver la version de votre navigateur, cliquez **sur Identifier la
version de mon navigateur.**
