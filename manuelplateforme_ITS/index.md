...
Naviguer sur la  plateforme Isograd
...
Cliquez sur **Compte** dans le menu principal pour accéder à la page ** Votre ****compte**, puis cliquez sur **Alerte ****c****rédit**.
...
Pour ce faire, vous devez sélectionner **Candidats** dans le menu principal.
...
Cliquez sur **Télécharger le modèle de fichier** et téléchargez le sur votre ordinateur.
...
**Mode plein écran**** (Fonction****nalité**** Anti-****Triche****):**
...
Si un candidat quitte le mode plein écran ou tente d’ouvrir un nouvel onglet, le système l’invitera à revenir à la page du test.

S’il ne se remet pas en mode plein écran sur son test dans les 10 secondes qui suivent, il sera automatiquement déconnecté de son test.
...
En cliquant sur  l’icône **Affichage**, vous pourrez voir la question, la réponse  du candidat, et la bonne réponse attendue.
...
Une fois qu’un groupe est sélectionné, cliquez sur** ****Rapports de groupe** :
...
Sélectionnez ensuite  l’onglet ** Rapport d****e progression** dans la fiche du candidat.
...
Pour informer les candidats qu’un test leur a été attribué, plusieurs options d’envoi d’e-mails vous sont fournies.
...
Un modèle d’e-mail d’invitation standard est disponible sur votre compte. Vous pouvez modifier ou dupliquer ce modèle standard.
...
Pour accéder aux modèles d’e-mail, cliquez sur **Emails** dans le menu principal. La  fenêtre **Gestion des ****envois**** ****programmé****s**** **s’affiche. Vous verez tout vos mail programmés.
...
Vous pouvez afficher les dates et heures au format américain ou européen, et sélectionner votre fuseau horaire. Vous pouvez également définir le temps supplémentaire aloué pour les personnes en situation d’handicap. 
...
Dans le menu principal, sélectionnez** Paramètres**, puis cliquez sur **Profils**** de compétences** puis cliquez sur  le bouton rouge** Ajouter un profil**.
